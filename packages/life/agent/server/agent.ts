...
import type { AgentDefinition, Config, Context, Models } from "../types";
...
export class AgentServer {
  ...
  constructor(params: {
    ...
    for (const definition of this.definition.actions)
      this.actions[definition.name] = new ActionServer(this, definition);
    for (const definition of this.definition.memories)
      this.memories[definition.name] = new MemoryServer(this, definition);
    for (const definition of this.definition.stores)
      this.stores[definition.name] = new StoreServer(this, definition);
    for (const definition of this.definition.effects)
      this.effects[definition.name] = new EffectServer(this, definition);
